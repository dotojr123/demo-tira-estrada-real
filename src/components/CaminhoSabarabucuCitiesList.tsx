...
interface CaminhoSabarabucuCitiesListProps {
  title: string;
  subtitle: string;
  cities: string[];
}

const CaminhoSabarabucuCitiesList: React.FC<CaminhoSabarabucuCitiesListProps> = ({ title, subtitle, cities }) => {
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
            {currentCities.map((city, index) => (
              <div
                ...
                data-city-name={city}
                onClick={() => window.location.href = `/caminhos/sabarabucu/${generateSlug(city)}`}
              >
                {/* City Image */}
                <div style={{ 
                  width: '100%', 
                ...
                <div style={{ padding: '16px' }}>
                  ...
                  <div style={{ textAlign: 'center', marginBottom: '16px' }}>
                    <a
                      href={`/caminhos/sabarabucu/${generateSlug(city)}`}
                      className="transition-colors duration-200"
                      style={{
                        color: '#EDA10E',
                        fontFamily: 'Poppins, sans-serif',
...
export default CaminhoSabarabucuCitiesList;