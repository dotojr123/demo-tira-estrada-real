...
const CaminhoVelhoInfoCards: React.FC = () => {
  const desktopMetrics: InfoMetric[] = [
    ...
    {
      icon: '⏱️',
      value: '🚲 15 dias 🚗 8 dias 🚶 48 dias 🐎 24 dias',
      label: 'Tempo de Viagem'
    },
    {
      icon: '⛰️',
      value: '11.5% asfalto · 6% trilha · 82.5% estrada de terra',
      label: 'Tipos de terreno'
    },
    {
      icon: '📈',
      value: 'Dos 710 km, 320 km são subidas e descidas',
  ...
  const mobileMetrics = [
    ...
    },
    {
      ...
      items: ['🚴‍♂️ 15 dias', '🚗 8 dias', '🚶 48 dias', '🐎 24 dias']
    },
    {
      title: 'Tipos de terreno',
      items: ['🛣️ 11,5% asfalto', '🥾 6% trilha', '🚜 82,5% estrada de terra']
    },
    {
        ...
        >
          ...
          >
            <div className="map-wrapper">
              <iframe
                src="https://www.google.com/maps/d/u/0/embed?mid=1Xu0C0xc1MowtgWQKiDDrmPvPsltX8q0&ehbc=2E312F"
                width="100%"
                height="520"
                style={{ border: 0 }}
                allowFullScreen
                loading="lazy"
                title="Mapa do Caminho Velho"
              />
            </div>
          </div>
        </div>
...
export default CaminhoVelhoInfoCards;